...
.test.values.from.assign.function <- function(connection)
{
  ...
  expect_true(.assign(datasources = connection,new.variable.name = "test.var.1",value=server.call, "numeric", asynchronous = FALSE))
  expect_true(ds.assign.value(datasources = connection, new.variable.name = "test.var.1",value=server.call,"numeric",asynchronous = FALSE))
...
{
  expect_error(.assign(datasources = connection,new.variable.name = "test.var.1", value="", "integer",asynchronous = FALSE))
  expect_false(.assign(datasources = connection,new.variable.name = "test.var.1", value="D$RUBBISH", "integer",asynchronous = FALSE))
  expect_false(.assign(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", "integer",asynchronous = FALSE))
  expect_false(.assign(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", "NULL",asynchronous = FALSE))

  expect_false(ds.assign.value(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", "integer",asynchronous = FALSE))
  expect_false(ds.assign.value(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", "integer",asynchronous = FALSE))
  expect_false(ds.assign.value(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", "NULL",asynchronous = FALSE))
  expect_false(ds.assign.value(datasources = connection, new.variable.name = "test.var.1",value="","integer",asynchronous = FALSE))
  
  ds.assign.value(datasources = connection, new.variable.name = "test.var.1",value="D$RUBBISH","integer",asynchronous = FALSE)
...
.test.no.variable.names <- function(connection)
{
  ...
  expect_error(.assign(datasources = connection, NULL, value ="D$INTEGER"))
  expect_error(.assign(datasources = connection, "", value ="D$INTEGER"))
  
  expect_false(ds.assign.value(datasources = connection))
  expect_false(ds.assign.value(datasources = connection, NULL, value ="D$INTEGER"))
  expect_false(ds.assign.value(datasources = connection, "", value ="D$INTEGER"))
}
