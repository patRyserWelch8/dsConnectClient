...
{
  expect_true(TRUE)
  outcome <- dsav.assign.error.not.stop(datasources = connection, new.variable.name = variable.name, 
                     value = value, class.type = class.type, asynchronous = FALSE)
  
  
  results <- testthat::evaluate_promise(dsav.assign.error.stop( new.variable.name = variable.name, 
...
{
  expect_true(dsav.assign.error.stop(datasources = connection, new.variable.name = "test.var.1", 
...
.test.values.from.assign.function <- function(connection)
{
  ...
  expect_true(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1",value = server.call, class.type =  "numeric", asynchronous = FALSE))
  ...
  expect_true(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1",value=server.call, 
                      class.type = "numeric", asynchronous = FALSE))
  expect_true(ds.assign.value(datasources = connection, new.variable.name = "test.var.1",value=server.call,
                              class.type = "numeric",asynchronous = FALSE))
}
...
{ 
  expect_error(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1", value="", class.type = "integer",asynchronous = FALSE))
  expect_false(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1", value="D$RUBBISH", class.type = "integer",asynchronous = FALSE))
  
  expect_false(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1", value="D$RUBBISH", class.type = "integer",asynchronous = FALSE))
  expect_false(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", class.type =  "integer",asynchronous = FALSE))
  expect_false(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1",value="D$RUBBISH", class.type =  "NULL",asynchronous = FALSE))
  ...
  expect_false(dsav.assign.error.stop(datasources = connection,new.variable.name = "test.var.1",value=server.call, class.type = "numeric", asynchronous = FALSE))
...
{
  expect_error(dsav.assign.error.stop())
  expect_error(dsav.assign.error.stop(NULL, "new.var", value ="D$INTEGER"))
...
.test.no.variable.names <- function(connection)
{
  ...
  expect_error(dsav.assign.error.stop(datasources = connection))
  expect_error(dsav.assign.error.stop(datasources = connection, class.type = NULL, value ="D$INTEGER"))
  expect_error(dsav.assign.error.stop(datasources = connection, class.type = "", value ="D$INTEGER"))
...
{
  expect_error(dsav.assign.error.stop(datasources = connection, "test.var", ""))
